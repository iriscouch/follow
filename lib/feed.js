...
function Feed (opts) {
  ...
  self.heartbeat         = opts.timeout || opts.heartbeat || DEFAULT_HEARTBEAT; 
  //self.timeout           = opts.timeout || opts.heartbeat || DEFAULT_HEARTBEAT;
